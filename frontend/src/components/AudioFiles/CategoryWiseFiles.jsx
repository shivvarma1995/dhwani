...
import { faAngleRight, faAngleLeft, faHeart, faBookmark, faPlay, faPencilAlt } from '@fortawesome/free-solid-svg-icons';
        ...
        >
            <>
                {categories.map((category, index) => {
                    if (audiofiles[index].length > 0) {
                        return (
                            <div key={category.category_id} className='mt-2'
                            data-aos="fade-up" data-aos-delay="100"
                            >
                                <h3 className="home-heading">{category.category_name}</h3>
                                <Slider {...settings}>
                                                    ...
                                                    <div className="details">
                                                        <div className="center">
                                                            <Row>
                                                                ...
                                                                {
                                                                /* <Col md={2} sm={2} xs={6}>
                                                                    <FontAwesomeIcon style={{ color: 'white', fontWeight: 900 }} aria-hidden="true"
                                                                        icon={regularHeart} />
                                                                </Col> */
                                                                }
